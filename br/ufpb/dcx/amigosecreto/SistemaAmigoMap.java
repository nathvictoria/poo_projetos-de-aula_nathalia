...
public class SistemaAmigoMap {
    private Map<String, Amigo> amigos; // Chave: e-mail em minúsculas
    ...
    public void cadastraAmigo(String nomeAmigo, String emailAmigo) throws AmigoJaExisteException {
        String emailKey = emailAmigo.toLowerCase();
        if (this.amigos.containsKey(emailKey)) {
            throw new AmigoJaExisteException("Amigo com e-mail " + emailAmigo + " já está cadastrado.");
        }
        this.amigos.put(emailKey, new Amigo(nomeAmigo, emailAmigo));
    }

    public Amigo pesquisaAmigo(String emailAmigo) throws AmigoInexistenteException {
        Amigo a = this.amigos.get(emailAmigo.toLowerCase());
        if (a == null) {
